...
>
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('template/assets/vendor/libs/select2/select2.min.css')}}">
    <link rel="stylesheet" href="{{ asset('template/assets/vendor/libs/select2/select2-bootstrap-5-theme.min.css')}}">
    ...
    <link rel="stylesheet" href="{{ asset('template/assets/vendor/libs/datatables-bs5/responsive.bootstrap5.css')}}">
